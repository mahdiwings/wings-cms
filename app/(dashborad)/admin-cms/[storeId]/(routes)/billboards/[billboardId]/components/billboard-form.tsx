    ...
    try {
      ...
      if (initialData) {
        await axios.patch(
          ...
          { lable: data.label, image: data.imageUrl },
          {
            headers: {
              authorization: `${token}`,
            },
      ...
      router.refresh();
      router.push(`/admin-cms/${params.storeId}/billboards`);
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  {/* <input type="text" value={field.value ? [field.value] : []} onChange={(url => field.onChange(url))} />
                   */}
                   <ImageUpload
